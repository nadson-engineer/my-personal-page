      ...
      <div className="flex min-h-0 flex-col gap-y-8 w-full">
        <div className="flex flex-col gap-y-4 items-center justify-center">
          ...
          <div className="flex flex-col gap-y-3 items-center justify-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Gosto de construir coisas</h2>
            <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
              Já participei de {DATA.hackathons.length} hackathons, unindo pessoas
              de diferentes lugares para construir soluções incríveis em poucos dias.
              Uma experiência que mostra o que um grupo motivado e apaixonado é
              capaz de criar sob pressão.
            </p>
          </div>
        </div>
        <Timeline>
